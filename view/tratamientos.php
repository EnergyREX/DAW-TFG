...
?>
  ...
  <div class="data">
    <h1>Tratamientos</h1>
  <div class="data__options"><span>Tratamientos</span><input type="text" placeholder="Esto aún no tiene función"><button>Buscar</button> <button>Filtro</button> <button class="insert__btn"><i class="fa-solid fa-plus"></i><span class="btn__text">Insertar...</span></button> </div>
